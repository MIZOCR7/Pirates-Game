...
class Player(pygame.sprite.Sprite):
  def __init__(self, pos, groups, collosion_sprites, semi_collosion_sprites, frames, data): 
    ...
    self.hitbox_rect = self.rect.inflate(-76, -34)
  ...
  def check_contact(self):
    ...
    collide_rects = [sprite.rect for sprite in self.collosion_sprites]
    semi_collide_rect = [sprite.rect for sprite in self.semi_collosion_sprites]
    ...
    self.platform = None
    sprites = self.collosion_sprites.sprites() + self.semi_collosion_sprites.sprites()
